...
class m190309_070608_blog_category extends Migration
{
    ...
    public function safeUp()
    {
        ...
        if (Yii::$app->db->getTableSchema('{{%blog_category}}', true) === null) {
            $this->createTable(
                '{{%blog_category}}',
                [
                    ...
                    'widget_type' => $this->integer(11)->notNull(),
                    'read_icon_class' => $this->string(60)->null()->defaultValue(null),
                    'read_more_text' => $this->string(60)->null()->defaultValue(null),
