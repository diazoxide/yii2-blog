...
use diazoxide\blog\widgets\Slider2;
...
<div id="blog-container">
    ...
    <div class="col-md-8 col-md-push-4 home-slider-container">
        ...
        <div class="top-buffer-20-xs home-white-content row">
			...
			foreach (
				$featuredCategories->where( [
					'widget_type_id' => 1,
					'is_featured'    => true
				] )->limit( 3 )->all() as $category
			): ?>
                <div class="col-md-4">
					<?= $category->widget ?>
                </div>
        ...
        <div class="top-buffer-20-xs home-white-content row">
			...
			foreach (
				$featuredCategories->where( [
					'widget_type_id' => 7,
					'is_featured'    => true
				] )->offset( 2 )->limit( 3 )->all() as $category
			): ?>
                <div class="col-md-4">
					<?= $category->widget ?>
                </div>
        ...
        <div class="top-buffer-20-xs home-white-content row">
			...
			foreach (
				$featuredCategories->where( [
					'widget_type_id' => 7,
					'is_featured'    => true
				] )->offset( 0 )->limit( 2 )->all() as $category
			): ?>
                <div class="col-md-6">
					<?= $category->widget ?>
                </div>
        ...
        <div class="home-feed nopadding-xs" id="home-feed-container">
            <div id="home_feed" class="top-buffer-20-xs top-buffer-0-md" style="height: 100vh;">
				<?= Feed::widget( [
					...
					'item_options'                   => [
						'tag'   => 'article',
						'class' => 'item col-xs-12 top-buffer-10-xs left-padding-0-xs right-padding-10-xs'
					],
					'list_options'                   => [ 'class'=>'feed-widget-listview','style' => 'overflow-y: scroll; max-height: 100vh;' ],
					'custom_js'                      => "var sidebar = new StickySidebar('#home-feed-container', {
